/* ============================================================
   ...
   ============================================================ */
import { loadConfig, onChange, cacheConfig, exportConfigFile, state, ensureItemIds } from './state.js';
import { initResumeMode, refreshResumeUI, toggleResumeMode } from './resume.js';
...
async function boot() {
  ...
  if (ensureItemIds()) cacheConfig(); // stable card IDs (rides along with next publish)
  ...
  document.addEventListener('click', (e) => {
    ...
    if (e.target.closest('[data-resume-toggle]')) { toggleResumeMode(); return; }
